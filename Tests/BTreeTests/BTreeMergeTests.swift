...
class BTreeMergeTests: XCTestCase {
  ...
  func makeTree<S: Sequence>(_ s: S, order: Int = 5, keysPerNode: Int? = nil) -> Tree
  where S.Element == Int {
  ...
  func test_subtractingSequenceByGrouping() {
    ...
    assertEqualElements(
      BTree<Int, String>().subtracting(sortedKeys: [1, 2, 3], by: .groupingMatches),
      []
    )
  ...
  func test_subtractingSequenceByCounting() {
    ...
    assertEqualElements(
      BTree<Int, String>().subtracting(sortedKeys: [1, 2, 3], by: .countingMatches),
      []
    )
  ...
  func test_intersectionWithSequenceByGrouping() {
    ...
    assertEqualElements(
      BTree<Int, String>().intersection(sortedKeys: [1, 2, 3], by: .groupingMatches),
      []
    )
  ...
  func test_intersectionWithSequenceByCounting() {
    ...
    assertEqualElements(
      BTree<Int, String>().intersection(sortedKeys: [1, 2, 3], by: .countingMatches),
      []
    )
