...
func assertEqualElements<Element: Equatable, S1: Sequence, S2: Sequence>(
  _ a: S1,
  _ b: S2,
...
func assertEqualElements<T1: Equatable, T2: Equatable, S1: Sequence, S2: Sequence>(
  _ a: S1,
  _ b: S2,
  file: StaticString = #file,
  line: UInt = #line
) where S1.Element == (T1, T2), S2.Element == (T1, T2) {
  let aa = Array(a)
  let ba = Array(b)
...
>(
  ...
  file: StaticString = #file,
  line: UInt = #line
) where S1.Element == S1W, S2.Element == S2W, S1W.Element == Element, S2W.Element == Element {
...
extension BTree {
  internal func assertKeysEqual(
    _ other: BTree<Key, Value>,
    file: StaticString = #file,
    line: UInt = #line
  ) {
  ...
  internal func assertKeysEqual<S: Sequence>(_ s: S, file: StaticString = #file, line: UInt = #line)
  where S.Element == Key {
