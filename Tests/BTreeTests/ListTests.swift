...
class ListTests: XCTestCase {
  ...
  func testAppendContentsOfList() {
    ...
    func appendAsSequence<E, S: Sequence>(_ list: inout List<E>, _ elements: S)
    where S.Element == E {
  ...
  func testInsertContentsOfList() {
    ...
    var copy = list
    func insertAsSequence<E, S: Sequence>(_ list: inout List<E>, _ elements: S, at index: Int)
    where S.Element == E {
  ...
  func testReplaceRangeWithSequence() {
    ...
    func replaceAsSequence<E, C: Collection>(
      _ list: inout List<E>,
