...
extension List {
  ...
  ///
  /// - Complexity: O(`count`)
  public func reduce<T>(_ initialResult: T, _ nextPartialResult: (T, Element) throws -> T) rethrows
    -> T
  {
...
extension List {
  ...
  public mutating func insert<S: Sequence>(contentsOf elements: S, at index: Int)
...
extension List: RangeReplaceableCollection {
  ...
  public mutating func replaceSubrange<C: Collection>(_ range: Range<Int>, with elements: C)
