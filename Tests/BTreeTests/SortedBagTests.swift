...
class SortedBagTests: XCTestCase {
  ...
  func test_indexing() {
    ...
    XCTAssertEqual(
      s.index(index, offsetBy: 4, limitedBy: s.index(ofOffset: 8)),
      s.index(ofOffset: 6)
    )
  ...
  func test_subtractionOfRange() {
    ...
    assertEqualElements(
      s.subtracting(elementsIn: 100..<9_900),
      (0..<100).repeatEach(2) + (9_900..<10_000).repeatEach(2)
    )
    ...
    assertEqualElements(
      s.subtracting(elementsIn: 100...9_900),
      (0..<100).repeatEach(2) + (9_901..<10_000).repeatEach(2)
    )
    ...
    assertEqualElements(
      s,
      (0..<100).repeatEach(2) + (901..<1_000).repeatEach(2) + (9_000..<10_000).repeatEach(2)
    )
  }
  ...
  func test_shiftStartingAtElement() {
    ...
    assertEqualElements(
      a,
      [0, 0, 2, 2, 4, 4, 11, 11, 13, 13, 15, 15, 17, 17, 19, 19, 21, 21, 23, 23]
    )

    a.shift(startingAt: 19, by: -1)
    assertEqualElements(
      a,
      [0, 0, 2, 2, 4, 4, 11, 11, 13, 13, 15, 15, 17, 17, 18, 18, 20, 20, 22, 22]
    )
  ...
  func test_shiftStartingAtIndex() {
    ...
    assertEqualElements(
      a,
      [0, 0, 2, 2, 4, 4, 6, 11, 13, 13, 15, 15, 17, 17, 19, 19, 21, 21, 23, 23]
    )

    a.shift(startingAt: a.index(ofOffset: 12), by: -1)
    assertEqualElements(
      a,
      [0, 0, 2, 2, 4, 4, 6, 11, 13, 13, 15, 15, 16, 16, 18, 18, 20, 20, 22, 22]
    )

    a.shift(startingAt: a.index(ofOffset: 4), by: -1)
    assertEqualElements(
      a,
      [0, 0, 2, 2, 3, 3, 5, 10, 12, 12, 14, 14, 15, 15, 17, 17, 19, 19, 21, 21]
    )

    a.shift(startingAt: a.index(ofOffset: 14), by: -2)
    assertEqualElements(
      a,
      [0, 0, 2, 2, 3, 3, 5, 10, 12, 12, 14, 14, 15, 15, 15, 15, 17, 17, 19, 19]
    )
    ...
    assertEqualElements(
      a,
      [5, 5, 7, 7, 8, 8, 10, 15, 17, 17, 19, 19, 20, 20, 20, 20, 22, 22, 24, 24]
    )

    a.shift(startingAt: a.index(ofOffset: 13), by: 5)
    assertEqualElements(
      a,
      [5, 5, 7, 7, 8, 8, 10, 15, 17, 17, 19, 19, 20, 25, 25, 25, 27, 27, 29, 29]
    )
